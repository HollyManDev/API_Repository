...
namespace Holy_Man_API.Services.MessageService
{
    public interface MessageInterface
    {
        ...
        Task<ServiceResponse<List<MessageModel>>> CreateMessage(MessageView newMessage);
        Task<ServiceResponse<MessageModel>> FindMessage(int id);
        Task<ServiceResponse<List<MessageModel>>> UpdateMessage(MessageView UpdateMessage);
